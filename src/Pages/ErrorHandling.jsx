    ...
    return (
        <div className='bg-[#D2D2D2]'>
            <div className='text-center'>
                ...
                <button onClick={()=>navigate('/home')} className='bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-center
                 text-white rounded-[4px] w-[150px] h-[48px] mt-4 mb-10'>Go Back</button>
            </div>
